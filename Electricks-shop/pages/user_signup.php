        ...
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom">
                    <p style="font-size:160%;"><b>Hand-E-Craft - Registration</b></p>
                </a>
...
?>
    ...
    <div class="page-header" >
        <div class="page-header-image" style="background-image:url('https://indian-retailer.s3.ap-south-1.amazonaws.com/s3fs-public/2021-08/hands-make-potter-decorative-pattern-earthenware.jpg')"></div>
        <div class="container">
                    ...
                    <form class="form" method="post" action="">
                       <!-- <div class="header header-primary text-center">
                            <br><br><div class="logo-container">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWjFbxGQvrdetZADQRerj6Ik_OGEFKr4kC8A&usqp=CAU">
                                insert logo here
                            </div>
                        </div>-->
                        <div class="content">

...
<body class="index-page sidebar-collapse">
    ...
    <!-- End Navbar -->
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('https://indian-retailer.s3.ap-south-1.amazonaws.com/s3fs-public/2021-08/hands-make-potter-decorative-pattern-earthenware.jpg');"></div>
    <div class="wrapper">
...
if(isset($_POST['submit'])){
   ...
   // move_uploaded_file($_FILES["prod_pic3"]["tmp_name"],"../uploads/" . $_FILES["prod_pic3"]["name"]);         
    ...
    if(empty($prod_name) || empty($prod_desc) || empty($prod_qty) || empty($prod_cost) || empty($prod_price) || empty($category) 
        || empty($supplier) || empty($prod_serial) || empty($prod_pic1)){    
        ...
        $query = "INSERT INTO products (prod_name, prod_desc, prod_qty, prod_cost, prod_price, category, supplier, prod_serial, prod_pic1) 
        VALUES ('$prod_name','$prod_desc','$prod_qty','$prod_cost','$prod_price','$category','$supplier','$prod_serial','$prod_pic1')";  
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <div class="form-group">
                        ...
                        <label for="prod_pic1">Picture :</label>
                        <div class="input-group">

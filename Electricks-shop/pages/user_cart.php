    ...
    <div class="wrapper"><br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      <h4><p style="font-size:160%;"><b>   <?php
                                 include('../config/dbconn.php');
                                 $query=mysqli_query($dbconn,"SELECT * FROM `users` WHERE user_id='".$_SESSION['id']."'");
                                 $row=mysqli_fetch_array($query);
                                 $cid=$row['user_id'];
                                 echo $row['firstname'];
                                ?>'s Shopping Cart</b></p></h4>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <option value="Anaimalai City">Anaimalai</option>
                      <option value="Chinnavedampatti City">Chinnavedampatti</option>
                      <option value="Idikarai City">Idikarai</option>
                      <option value="Kandiyur City">Kandiyur</option>
                      <option value="Karamadai City">Karamadai</option>
                      <option value="Kovaipudhur City">Kovaipudhur</option>
                      <option value="Marudhamalai City">Marudhamalai</option>
                      <option value="Mettupalayam City">Mettupalayam</option>
                      <option value="Neelambur City">Neelambur</option>
                      <option value="Periyanaickenpalayam City">Periyanaickenpalayam</option>
                      <option value="Saravanampatti City">Saravanampatti</option>
                      <option value="Sulur City">Sulur</option>
                      <option value="Thondamuthur City">Thondamuthur</option>
                      <option value="Veerapandi City">Veerapandi</option>
                      <option value="Valparai City">Valparai</option>
                      <option value="Vattamalaipalayam City">Vattamalaipalayam</option>-->
                      </select>  
                      </div>
